...
You can see if the job has started with `squeue -u $USER` and stop the job with `scancel jobID`. The a40 file specifies the a40 GPU, a100 specices a100 GPU. Seems that a100's are in higher demand
